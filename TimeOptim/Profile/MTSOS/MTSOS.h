...
int so_lu_solve(cs* Abig, double* bbig, css** S, int orderOkay);
...
int so_MTSOS(problem_params* p_params, algorithm_flags* flags, algorithm_params* a_params, optional_params* o_params, double** p_b, double** p_u, double** p_v, double* pfx, double** p_timers, int* piterations);
